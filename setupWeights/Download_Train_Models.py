...
MODEL_CONFIGS = {
    "FLUX_Dev": {
        ...
        "name": "FLUX Dev Training Models",
        "description": "FLUX.1-dev model with FP16 precision for training",
    ...
    "FLUX_Dev_FP8": {
        ...
        "name": "FLUX Dev FP8 Training Models",
        "description": "FLUX.1-dev model with FP8 precision for training",
        "default_dir": "FLUX_Training_Models"
    },
    "FLUX_Krea_DEV": {
        "repo_id": "MonsterMMORPG/Kohya_Train",
        ...
        "name": "FLUX Krea Dev Training Models",
        "description": "FLUX.1 Krea Dev model for training",
        "default_dir": "FLUX_Training_Models"
    },
    "FLUX_SPRO_Realism": {
        "repo_id": "MonsterMMORPG/Kohya_Train",
        ...
        "name": "FLUX SPRO Realism Training Models",
        "description": "FLUX SPRO model with BF16 precision for realistic training",
        "default_dir": "FLUX_Training_Models"
    }
}
...
def get_model_choice():
    ...
    print("\nAvailable models:")
    print("1. FLUX Dev Training Models")
    print("   - t5xxl_fp16.safetensors")
    print("   - flux1-dev.safetensors")
    print("   - clip_l.safetensors")
    print("   - ae.safetensors")
    print("   Default directory: FLUX_Training_Models")
    print()
    print("2. FLUX Dev FP8 Training Models")
    print("   - t5xxl_fp16.safetensors")
    print("   - flux1-dev-fp8.safetensors")
    print("   - clip_l.safetensors")
    print("   - ae.safetensors")
    print("   Default directory: FLUX_Training_Models")
    print()
    print("3. FLUX Krea Dev Training Models")
    print("   - t5xxl_fp16.safetensors")
    print("   - flux1-krea-dev.safetensors")
    print("   - clip_l.safetensors")
    print("   - ae.safetensors")
    print("   Default directory: FLUX_Training_Models")
    print()
    print("4. FLUX SPRO Realism Training Models")
    print("   - t5xxl_fp16.safetensors")
    print("   - FLUX-SRPO-bf16.safetensors")
    print("   - clip_l.safetensors")
    print("   - ae.safetensors")
    print("   Default directory: FLUX_Training_Models")
    print()
    ...
    while True:
        try:
            choice = input("Please select model (1-4): ").strip()
            if choice == "1":
                return "FLUX_Dev"
            elif choice == "2":
                return "FLUX_Dev_FP8"
            elif choice == "3":
                return "FLUX_Krea_DEV"
            elif choice == "4":
                return "FLUX_SPRO_Realism"
            else:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Download training models for FLUX')
    parser.add_argument('--model', choices=['FLUX_Dev', 'FLUX_Dev_FP8', 'FLUX_Krea_DEV', 'FLUX_SPRO_Realism'],
                       help='Model to download: FLUX_Dev, FLUX_Dev_FP8, FLUX_Krea_DEV, or FLUX_SPRO_Realism')
    parser.add_argument('--dir', type=str,
                       help='Download directory (supports both full and relative paths for Windows and Linux)')

    args = parser.parse_args()

    # If no model specified, download FLUX_Dev and FLUX_SPRO_Realism by default
    if not args.model:
        print("No model specified. Downloading FLUX_Dev and FLUX_SPRO_Realism by default...")
        print("Available options:")
        print("  --model FLUX_Dev        : Download FLUX Dev Training Models")
        print("  --model FLUX_Dev_FP8    : Download FLUX Dev FP8 Training Models")
        print("  --model FLUX_Krea_DEV   : Download FLUX Krea Dev Training Models")
        print("  --model FLUX_SPRO_Realism : Download FLUX SPRO Realism Training Models")
        print()

        # Download both FLUX_Dev and FLUX_SPRO_Realism
        download_models("FLUX_Dev", args.dir)
        download_models("FLUX_SPRO_Realism", args.dir)
    else:
