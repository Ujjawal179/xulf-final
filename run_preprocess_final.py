...
def main() -> None:
    ...
    parser.add_argument("--dest_root", type=str, default="Dataset/final-imgs/1_ohwx_woman", help='Root output folder (e.g. "Dataset")')
    ...
    gen2 = resize_images(
            Model_Dir=str(model_dir),
            input_folder=str(output_root),
            output_folder=str(dest_root),
